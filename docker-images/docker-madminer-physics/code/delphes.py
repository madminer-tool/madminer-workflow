...
dp.add_sample(
    lhe_filename=event_path + '/unweighted_events.lhe.gz', #'/madminer/code/mg_processes/signal/Events/run_01/unweighted_events.lhe.gz'
    hepmc_filename=event_path + '/tag_1_pythia8_events.hepmc.gz', #'/madminer/code/mg_processes/signal/Events/run_01/tag_1_pythia8_events.hepmc.gz'
    is_background=False,
...
dp.run_delphes(
    ...
    delphes_card='/madminer/code/cards/delphes_card.dat',
    log_file='/madminer/log_delphes.log')
...
dp.save("/madminer/data/madminer_example_with_data_"+str(benchmark)+".h5")
