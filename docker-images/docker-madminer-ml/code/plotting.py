...
variables_to_plot['theta_grid'] = np.load('/madminer/rates/grid.npy')  #np.load(gridpath)
...
variables_to_plot['p_values_expected_rate'], variables_to_plot['best_fit_expected_rate'] = np.load('/madminer/rates/rate.npy')  #np.load(ratepath)
...
variables_to_plot['p_values_expected_histo'], variables_to_plot['best_fit_expected_histo'] = np.load('/madminer/rates/histo.npy')
...
variables_to_plot['p_values_expected_histo_kin'], variables_to_plot['best_fit_expected_histo_kin'] = np.load('/madminer/rates/histo_kin.npy')
...
for method in methods:
  if(method in ['alice','alices','cascal','carl','rolr', 'rascal'] ):
    variables_to_plot['p_values_expected_'+method] = np.load('/madminer/results/'+method+'/ml/'+method+'.npy')[0]
    variables_to_plot['best_fit_expected_'+method] = np.load('/madminer/results/'+method+'/ml/'+method+'.npy')[1]
    variables_to_plot['p_values_expected_'+method+'_kin'] = np.load('/madminer/results/'+method+'/ml/'+method+'_kin.npy')[0]
    variables_to_plot['best_fit_expected_'+method+'_kin'] = np.load('/madminer/results/'+method+'/ml/'+method+'_kin.npy')[1]


  if(method in ['sally','sallino'] ):
    variables_to_plot['p_values_expected_'+method] = np.load('/madminer/results/'+method+'/histo/'+method+'.npy')[0]
    variables_to_plot['best_fit_expected_'+method] = np.load('/madminer/results/'+method+'/histo/'+method+'.npy')[1]
    variables_to_plot['p_values_expected_'+method+'_kin'] = np.load('/madminer/results/'+method+'/histo/'+method+'_kin.npy')[0]
    variables_to_plot['best_fit_expected_'+method+'_kin'] = np.load('/madminer/results/'+method+'/histo/'+method+'_kin.npy')[1]    
...
if( plotting['all_methods']==True ):
  ...
  plt.tight_layout()
  plt.savefig('/madminer/plots/all_methods.png')
  ...
  for method in inputs['plotting']['correlations_methods']:
    ...
    if(method in ['alice','alices','cascal','carl','rolr', 'rascal']):
      ...
      if(len(inputs['evaluation'][method])==1):
        ...
        theta_test=np.load('/madminer/test/'+method+'/theta_test.npy')

        r_truth_test=np.load('/madminer/test/'+method+'/r_xz_test.npy')
        ...
        estimator_load.load('/madminer/models/'+method+'/'+method)

        llr_ml_test,_=estimator_load.evaluate_log_likelihood_ratio(
          theta='/madminer/test/'+method+'/theta_test.npy',
        ...
        plt.tight_layout()
        plt.savefig('/madminer/plots/correlation_'+method.upper()+'.png')



      if(len(inputs['evaluation'][method])==2):
        theta0_test=np.load('/madminer/test/'+method+'/theta0_test.npy')
        theta1_test=np.load('/madminer/test/'+method+'/theta1_test.npy')
        ...
        llr_ml_test,_=estimator_load.evaluate_log_likelihood_ratio(
          theta='/madminer/test/'+method+'/theta0_test.npy',
          x='/madminer/test/'+method+'/x_test.npy',
          evaluate_score=False,
          test_all_combinations=False,
        )
